...
public class AliFooter extends BaseFooter {
    ...
    public AliFooter(Context context) {
        this(context, R.drawable.progressbar, R.drawable.arrow, 0, false);
    }

    public AliFooter(Context context, boolean isShowText) {
        this(context, R.drawable.progressbar, R.drawable.arrow, 0, isShowText);
    }

    public AliFooter(Context context, int logoSrc) {
        this(context, R.drawable.progressbar, R.drawable.arrow, logoSrc, false);
    }

    public AliFooter(Context context, int logoSrc, boolean isShowText) {
        this(context, R.drawable.progressbar, R.drawable.arrow, logoSrc, isShowText);
    }
