...
public class SpringView extends ViewGroup {
    ...
    private onTouchCompleteListener onTouchCompleteListener;//监听碰触结束
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(onTouchCompleteListener!=null){
                    if(isBottom()){
                        onTouchCompleteListener.onBottomTouchComplete();
                    }
                    if(isTop()){
                        onTouchCompleteListener.onUpTouchComplete();
                    }
    ...
    public interface  onTouchCompleteListener{
        void onUpTouchComplete();
        void onBottomTouchComplete();
